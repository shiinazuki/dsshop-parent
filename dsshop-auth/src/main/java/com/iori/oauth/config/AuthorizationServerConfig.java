...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter(CustomUserAuthenticationConverter customUserAuthenticationConverter) {
        ...
        KeyPair keyPair = new KeyStoreKeyFactory(
                keyProperties.getKeyStore().getLocation(),                          //证书路径 myiori.jks
                keyProperties.getKeyStore().getSecret().toCharArray())              //证书秘钥 myiori
                .getKeyPair(keyProperties.getKeyStore().getAlias(),                     //证书别名 myiori
                        keyProperties.getKeyStore().getPassword().toCharArray());   //证书密码 myiori
